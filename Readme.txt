...
Setup Intruction: 
in main set the scheduler port number and infor port number to what was agreed upon by the out system. then change the port numbers and ip address to match what the elevators are running on. 
